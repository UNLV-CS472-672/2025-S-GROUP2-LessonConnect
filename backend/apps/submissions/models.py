...
class Submissions(models.Model):
    ...
    # assignment = models.ForeignKey("something.Assignment", on_delete=models.CASCADE)
...
class FileSubmissions(models.Model):
    ...
    # file = models.ForeignKey('something.MediaUploads', on_delete=models.CASCADE)
    def __str__(self):
        return f"File Submission for Submission ID {self.submission.id}"

class QuizSubmissions(models.Model):
    submission = models.OneToOneField(Submissions, on_delete=models.CASCADE)
    # quiz = models.ForeignKey('something.Quiz', on_delete=models.CASCADE)
    def __str__(self):
...
class StudentQuizAnswers(models.Model):
    ...
    # question = models.ForeignKey('something.Question', on_delete=models.CASCADE)
